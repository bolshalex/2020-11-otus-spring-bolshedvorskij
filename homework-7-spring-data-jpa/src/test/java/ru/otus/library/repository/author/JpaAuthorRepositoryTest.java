...
class JpaAuthorRepositoryTest {
    ...
    void shouldCreateAndReturnAuthor() {
        ...
        Author actualAuthor = authorRepository.saveAndFlush(author);
    ...
    void shouldUpdateAuthorBooks() {
        ...
        List<Book> actualBook = bookRepository.getByAuthorsId(author.getId());
    ...
    void shouldGetAuthorsByBookId() {
        ...
        List<Author> actualAuthors = authorRepository.getAllByBooksId(4L);
