...
public class CommentShell {
    ...
    public String createComment(@ShellOption({"-bookId"}) Long bookId,
    ...
    public String update(@ShellOption({"-id"}) Long commentId,
                         @ShellOption({"-t"}) String text) {
    ...
    public String getBookComments(@ShellOption({"-bookId"}) Long bookId) {
